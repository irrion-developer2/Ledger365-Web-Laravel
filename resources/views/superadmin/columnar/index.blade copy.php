                    ...
                    <div class="d-lg-flex align-items-center gap-3">
                        ...
                        {{-- <div class="col-lg-3">
                            <div>
                                ...
                                <label><input type="checkbox" class="toggle-vis" data-column="0" checked> Date</label><br>
                                <label><input type="checkbox" class="toggle-vis" data-column="1" checked> Particulars</label><br>
                                <label><input type="checkbox" class="toggle-vis" data-column="2" checked> Voucher No.</label>
                            </div>
                        </div> --}}
                    </div>
                    ...
                    <div class="table-responsive table-responsive-scroll border-0">
                        <table id="SalesColumnar-datatable" class="stripe row-border order-column" style="width:100%">
                            <thead>
                                ...
                                {{-- <tr>
                                    <th><input type="text" id="date" placeholder="Search Date"></th>
                                    <th><input type="text" id="particulars" placeholder="Search Particulars"></th>
                                    <th><input type="text" id="voucher_no" placeholder="Search Voucher No."></th>
                                    <th><input type="text" id="voucher_type" placeholder="Search Voucher Type"></th>
                                    <th><input type="text" id="buyer_name" placeholder="Search Buyer Name"></th>
                                    <th><input type="text" id="buyer_addr" placeholder="Search Buyer Addr"></th>
                                    <th><input type="text" id="state" placeholder="Search State"></th>
                                    <th><input type="text" id="country" placeholder="Search Country"></th>
                                    <th><input type="text" id="gstin" placeholder="Search GSTIN"></th>
                                    <th><input type="text" id="gst_registration_type" placeholder="Search Registration Type"></th>
                                    <th><input type="text" id="place_of_supply" placeholder="Search Place Of Supply"></th>
                                    <th><input type="text" id="gross_total" placeholder="Search Gross Total"></th>
                                    <th><input type="text" id="taxable_value" placeholder="Search Taxable Value"></th>
                                    <th><input type="text" id="duties_taxes" placeholder="Search Duties & Taxes"></th>
                                </tr> --}}
                            </thead>
                            <tbody>
...
<script>
    $(document).ready(function() {
        ...
        $('#voucher_type').on('keyup', function () {
            table.column(3).search(this.value).draw();
        });
        $('#buyer_name').on('keyup', function () {
            table.column(4).search(this.value).draw();
        });
        $('#buyer_addr').on('keyup', function () {
        ...
        $('#gst_registration_type').on('keyup', function () {
            table.column(9).search(this.value).draw();
        });
        $('#place_of_supply').on('keyup', function () {
            table.column(10).search(this.value).draw();
        });
        $('#gross_total').on('keyup', function () {
            table.column(11).search(this.value).draw();
        });
        $('#taxable_value').on('keyup', function () {
            table.column(12).search(this.value).draw();
        });
        $('#duties_taxes').on('keyup', function () {
