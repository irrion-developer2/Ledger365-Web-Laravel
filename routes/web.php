...
Route::middleware([
    ...
    Route::group(['middleware' => 'checkAdminRoleAndStatus'], function () {
        ...
        Route::get('count-mutliple-mail', [SendMailController::class, 'sendMails'])->name('count-mutliple-mail');
        ...
        Route::get('/email-log', [SendMailController::class, 'emailLogData'])->name('email-log.getData');
