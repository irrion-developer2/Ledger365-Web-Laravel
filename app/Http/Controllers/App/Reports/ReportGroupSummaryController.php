...
class ReportGroupSummaryController extends Controller
{
    ...
    public function getData(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            Log::info('Total first DB request execution time for ReportGroupSummaryController.getData:', [
            ...
            Log::info('Total end execution time for ReportGroupSummaryController.getData:', [
