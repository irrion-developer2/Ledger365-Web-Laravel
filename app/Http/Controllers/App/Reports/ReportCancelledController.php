...
class ReportCancelledController extends Controller
{
    ...
    public function getData(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $isCancelled = $request->get('is_cancelled', 1);
            ...
            Log::info('Total first DB request execution time for ReportCancelledController.getData:', [
            ...
            Log::info('Total end execution time for ReportCancelledController.getData:', [
