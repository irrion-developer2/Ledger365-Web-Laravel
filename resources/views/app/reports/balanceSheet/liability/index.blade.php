                        ...
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <div class="row m-0">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <li class="active text-white" aria-current="page">Group Summary</li>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 p-0" style="border-right: 1px solid rgba(0, 0, 0, .125);border-bottom: 1px solid rgba(0, 0, 0, .125);">
                                ...
                                <div class="table-responsive table-responsive-scroll border-0">
                                    <table id="balanceLiabilityDebitCreditSheet-datatable" class="stripe row-border order-column" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th>Debit</th>
...
<script>
    $(document).ready(function() {
        var liabilityDebitCreditTable = $('#balanceLiabilityDebitCreditSheet-datatable').DataTable({
            fixedColumns: {
                start: 1,
            },
            paging: false,
            ...
            ajax: {
                url: "{{ route('reports.BalanceSheetLiability.get-data', $liabilityId) }}",
                type: 'GET'
            },
            columns: [
                {data: 'name', name: 'name',
                    render: function(data, type, row) {
                        ...
                        url = url.replace(':id', row.id || '{{ $liabilityId }}'); // Handle missing id
