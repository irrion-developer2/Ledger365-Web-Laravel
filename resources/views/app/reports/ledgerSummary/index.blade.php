...
@section('title', __('Ledger Summary | PreciseCA'))
    ...
    <div class="page-wrapper">
        <div class="page-content pt-2">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-2">
                <div class="breadcrumb-title pe-3">Ledger Summary</div>
                <div class="ps-3">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive table-responsive-scroll border-0">
                        <table id="ledger-summary-datatable" class="stripe row-border order-column" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Ledger Name</th>
...
<script>
    ...
    new Vue({
        ...
        methods: {
            ...
            reloadTableData() {
                if (this.tableInitialized) {
                    $('#ledger-summary-datatable').DataTable().ajax.reload(null, false);
                }
            }
        },
        watch: {
        ...
        mounted() {
            ...
            $('#ledger-summary-datatable').on('init.dt', () => {
    ...
    $(document).ready(function() {
        const dataTable = $('#ledger-summary-datatable').DataTable({
            ...
            scrollY: 300,
            ajax: {
                url: "{{ route('LedgerSummary.get-data') }}",
                type: 'GET',
                data: function (d) {
