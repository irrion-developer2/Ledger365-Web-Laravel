...
@section("wrapper")
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 p-0" style="border-right: 1px solid rgba(0, 0, 0, .125);border-bottom: 1px solid rgba(0, 0, 0, .125);">
                                ...
                                @include('superadmin.reports.balanceSheet.dataTable.Liability')
    ...
    <span class="d-none">
        ...
        @include('superadmin.reports.balanceSheet.dataTable.ClosingStock')
        @include('superadmin.reports.balanceSheet.dataTable.Revenue')
    </span>
