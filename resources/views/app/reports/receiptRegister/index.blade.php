                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive table-responsive-scroll border-0">
                                    ...
                                    <table id="receipt-datatable" class="stripe row-border order-column" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Date</th>
                                                <th>Ledger</th>
...
<script>
        ...
        methods: {
            ...
            reloadTableData() {
                if (this.tableInitialized) {
                    $('#receipt-datatable').DataTable().ajax.reload(null, false);
                }
            }
        },
        watch: {
    ...
    $(document).ready(function() {
        ...
        var table = new DataTable('#receipt-datatable', {
            ...
            scrollY: 300,
            ajax: {
                url: "{{ route('ReceiptRegister.get-data') }}",
                type: 'GET',
                data: function (d) {
