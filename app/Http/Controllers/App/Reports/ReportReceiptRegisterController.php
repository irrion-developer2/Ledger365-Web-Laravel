...
class ReportReceiptRegisterController extends Controller
{
    ...
    {
        return view ('app.reports.receiptRegister.index');
    }
    ...
    public function getData(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            Log::info('Total first DB request execution time for ReportReceiptRegisterController.getData:', [
            ...
            Log::info('Total end execution time for ReportReceiptRegisterController.getData:', [
