                        ...
                        <div class="col-lg-12 px-2">
                            <div class="col">
                                <div class="accordion" id="accordionExample">
                                    ...
                                    @include('app.stock-items.accordion._accordion_item_one')
                                    @include('app.stock-items.accordion._accordion_item_two') 
                                    @include('app.stock-items.accordion._accordion_item_three') 
                                    {{-- @include('app.stock-items.accordion._accordion_item_four')  --}}
