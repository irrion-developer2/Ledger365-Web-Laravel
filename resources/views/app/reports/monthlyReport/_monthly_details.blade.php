                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Monthly Details for {{ $month }} {{ $year }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div id="vue-datepicker-app">
                        <div class="d-lg-flex align-items-center gap-2">
                            ...
                            <div class="col-lg-6">
                                <h5>Details for {{ $voucherTypeName }} - {{ $month }} {{ $year }}</h5>
                            </div>
                    ...
                    <div class="table-responsive table-responsive-scroll border-0">
                        <table id="monthly-datatable" class="stripe row-border order-column" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Date</th>
                                    <th>Ledger</th>
...
<script>
        ...
        methods: {
            ...
            reloadTableData() {
                if (this.tableInitialized) {
                    $('#monthly-datatable').DataTable().ajax.reload(null, false);
                }
            }
        },
        watch: {
    ...
    $(document).ready(function() {
        const dataTable = $('#monthly-datatable').DataTable({
            ...
            scrollY: 300,
            ajax: {
                url: "{{ route('Monthly.get-data') }}",
                type: 'GET',
                data: function (d) {
                    d.voucher_type_name = "{{ $voucherTypeName }}";
                    d.month = "{{ $month }}";
                    d.year = "{{ $year }}";
                }
            },
